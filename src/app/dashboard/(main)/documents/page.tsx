                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                     ...
                     <div className="grid grid-cols-4 items-center gap-4">
                      <Label htmlFor="type" className="text-right">Tipo</Label>
                       <Input id="type" name="type" placeholder="Ex: Contrato, Relatório..." className="col-span-3" required />
                    </div>
                     <div className="grid grid-cols-4 items-center gap-4">
                      <Label htmlFor="relatedTo" className="text-right">Relacionado a</Label>
                      <Input id="relatedTo" name="relatedTo" placeholder="Ex: Innovate Inc." className="col-span-3" required />
                    </div>
                  </div>
                </form>
                <DialogFooter>
                  <Button variant="outline" onClick={() => setIsDialogOpen(false)}>Cancelar</Button>
                  <Button type="submit" form="upload-doc-form">Salvar</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
        </div>
