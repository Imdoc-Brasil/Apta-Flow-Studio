...
const initialSectorsData = [
    { id: 'SEC-001', name: 'Administrativo', description: 'Atividades de escritório e gestão.' },
    { id: 'SEC-002', name: 'Produção', description: 'Linha de montagem e fabricação.' },
    { id: 'SEC-003', name: 'Logística', description: 'Armazenamento e expedição.' },
];
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Preencha os detalhes do novo setor ou departamento.</DialogDescription>
                </DialogHeader>
      ...
      <CardContent>
         {sectors.length > 0 ? (
            ...
            <div className="flex flex-col items-center gap-1 text-center">
                ...
                <Button className="mt-4" onClick={() => setIsDialogOpen(true)}>Adicionar Setor</Button>
            </div>
            </div>
         )}
      </CardContent>
