...
const initialPendingIssues = [
  ...
  },
  {
    ...
    exam: 'Espirometria',
    alteration: 'Alteração leve',
    status: 'Encaminhado ao Especialista',
    date: '2024-07-02',
  },
]
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Acompanhe exames com resultados alterados e outras pendências que
          impactam a emissão do ASO.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {issues.length > 0 ? (
              ...
              {issues.map((issue) => (
                <TableRow key={issue.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        issue.status === 'Aguardando Avaliação'
                          ? 'default'
                          : 'secondary'
                      }
                    >
