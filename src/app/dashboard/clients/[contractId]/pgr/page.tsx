    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          ...
          <Button size="sm" className="h-8 gap-1" onClick={() => setHasPgr(true)}>
        ...
        {hasPgr ? (
           <div className="flex flex-col items-center justify-center rounded-lg border border-dashed shadow-sm h-96 p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-md mx-auto mt-2">
              O documento base do PGR foi criado. Agora você pode começar a popular o inventário de riscos e a criar o plano de ação.
            </p>
            <div className="flex gap-2 mt-6">
                <Button asChild>
                    <Link href={`/dashboard/clients/${contractId}/pgr-inventory`}>Acessar Inventário de Riscos</Link>
                </Button>
                <Button variant="outline" asChild>
                    <Link href={`/dashboard/clients/${contractId}/pgr-action-plan`}>Ver Plano de Ação</Link>
                </Button>
            </div>
          </div>
        ) : (
          <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm h-96">
            <div className="flex flex-col items-center gap-1 text-center">
              ...
              <Button className="mt-4" onClick={() => setHasPgr(true)}>Gerar Documento PGR</Button>
            </div>
          </div>
        )}
      </CardContent>
