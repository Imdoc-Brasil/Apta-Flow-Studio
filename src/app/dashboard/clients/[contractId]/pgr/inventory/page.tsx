                  ...
                  <div className='space-y-6 px-4 py-6'>
                    ...
                    <div className='space-y-4 rounded-md border p-4'>
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                        ...
                        <div className='space-y-2'>
                          <Label htmlFor='exposureTypeDetail'>
                            Tipo de Exposição
                          </Label>
                          <Select
                        ...
                        <div className='space-y-2 rounded-md bg-muted/50 p-4'>
                          <div className='flex items-center gap-2'>
                            ...
                            <Label htmlFor='method-1' className='font-normal'>
                              Aplicação questionário de avaliação preliminar de
                              risco
                            </Label>
                          </div>
                          <div className='flex items-center gap-2'>
                          ...
                          <div className='flex items-center gap-2'>
                            ...
                            <Label htmlFor='method-3' className='font-normal'>
                              Informações fornecidas pelo representante da
                              empresa
                            </Label>
                          </div>
                          <div className='flex items-center gap-2'>
                          ...
                          <div className='flex items-center gap-2'>
                            ...
                            <Label htmlFor='method-5' className='font-normal'>
                              Aplicação de ferramenta de avaliação preliminar de
                              fatores de rico
                            </Label>
                          </div>
                        </div>
                    ...
                    <div className='space-y-4 rounded-md border p-4'>
                      ...
                      <div className='space-y-2 pt-4'>
                        ...
                        <div className='p-4 rounded-md border bg-muted/50'>
                           ...
                           <p className='text-sm text-muted-foreground mt-2'>{currentRiskDescription}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <TableRow key={item.id}>
                  <TableCell>
                    ...
                    <div className='text-sm text-muted-foreground'>
                      {
                        exposureTypeLabels[
                          item.exposureType as Exclude<ExposureType, ''>
                        ]
                      }
                    </div>
                  </TableCell>
