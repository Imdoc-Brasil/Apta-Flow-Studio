...
const initialPriceData = [
  ...
  { code: 'SST-01', name: 'PCMSO', price: 800.0, category: 'Programa' },
  { code: 'SST-02', name: 'PGR', price: 1200.0, category: 'Programa' },
]
  ...
  return (
    <Card>
      <CardHeader>
            ...
            <DialogContent className='sm:max-w-md'>
              <form onSubmit={handleAdjustment}>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Aplique um reajuste percentual a todos os itens da tabela de
                    preços deste cliente.
                  </DialogDescription>
                </DialogHeader>
        ...
        <CardDescription>
          Tabela de preços específica para este cliente, refletindo
          negociações.
        </CardDescription>
      </CardHeader>
      <CardContent>
