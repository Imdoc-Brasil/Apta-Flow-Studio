...
const initialEpcData = [
  {
    id: 'EPC-CLI-01',
    name: 'Sistema de Ventilação Local Exaustora',
    installationDate: '2023-01-20',
    status: 'Ativo',
  },
  {
    id: 'EPC-CLI-02',
    name: 'Guarda-corpo e Rodapé',
    installationDate: '2022-11-15',
    status: 'Ativo',
  },
  {
    id: 'EPC-CLI-03',
    name: 'Isolamento Acústico da Sala de Compressores',
  ...
  return (
    <Card>
      <CardHeader>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Registre um novo Equipamento de Proteção Coletiva instalado
                  na unidade.
                </DialogDescription>
              </DialogHeader>
        ...
        <CardDescription>
          Gerencie os Equipamentos de Proteção Coletiva (EPCs) instalados nas
          unidades do cliente.
        </CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <TableBody>
              {epcs.map((epc) => (
                <TableRow key={epc.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={epc.status === 'Ativo' ? 'secondary' : 'default'}
                    >
                      {epc.status}
                    </Badge>
                  </TableCell>
