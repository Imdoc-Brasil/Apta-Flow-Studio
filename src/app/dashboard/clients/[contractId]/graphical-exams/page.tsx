  ...
  return (
    <Card>
      <CardHeader>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Selecione o arquivo do laudo e o tipo de exame.
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                ...
                <Button type='submit' form='import-laudo-form' disabled={!selectedFile}>
                  Importar
                </Button>
              </DialogFooter>
            </DialogContent>
        ...
        <CardDescription>
          Gerencie os resultados de exames como audiometrias, espirometrias e
          ECGs.
        </CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <TableBody>
              {laudos.map((laudo) => (
                <TableRow key={laudo.id}>
                  ...
                  <TableCell>
                    <Badge variant='outline'>{laudo.examType}</Badge>
                  </TableCell>
