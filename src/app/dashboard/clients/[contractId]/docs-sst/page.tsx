  ...
  return (
    <Card>
      <CardHeader>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
                ...
                <div className='grid gap-4 py-4'>
                  <div className='grid grid-cols-4 items-center gap-4'>
                    ...
                    <Select name='docType' required>
                      ...
                      <SelectContent>
                        <SelectItem value='PGR'>
                          PGR - Prog. de Gerenciamento de Riscos
                        </SelectItem>
                        <SelectItem value='PCMSO'>
                          PCMSO - Prog. de Controle Médico
                        </SelectItem>
                        <SelectItem value='LTCAT'>
              ...
              <DialogFooter>
                ...
                <Button type='submit' form='generate-doc-form'>
                  Gerar
                </Button>
              </DialogFooter>
            </DialogContent>
        ...
        <CardDescription>
          Gere e gerencie os documentos de Saúde e Segurança do Trabalho para
          este cliente.
        </CardDescription>
      </CardHeader>
      <CardContent>
