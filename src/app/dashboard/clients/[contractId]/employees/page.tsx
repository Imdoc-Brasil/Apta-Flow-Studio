...
const initialEmployeesData = [
    { id: 'COL-001', name: 'João da Silva', cpf: '123.456.789-00', birthDate: '1990-05-15', role: 'Operador de Máquinas', sector: 'Produção' },
    { id: 'COL-002', name: 'Maria Oliveira', cpf: '987.654.321-00', birthDate: '1988-11-22', role: 'Analista Administrativo', sector: 'Administrativo' },
];
                    ...
                    <form id="add-employee-form" onSubmit={handleAddEmployee}>
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <Input id="cpf" name="cpf" className="col-span-3" required />
                            </div>
                            <div className="grid grid-cols-4 items-center gap-4">
            ...
            <TableBody>
             ...
             <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm h-96">
                <div className="flex flex-col items-center gap-1 text-center">
                    ...
                    <Button className="mt-4" onClick={() => setIsDialogOpen(true)}>Adicionar Colaborador</Button>
                </div>
            </div>
        )}
      </CardContent>
