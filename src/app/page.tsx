...
const features = [
  ...
  },
  {
    ...
    description:
      'Permita que os clientes enviem e rastreiem solicitações de serviço com facilidade.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Gere relatórios e painéis personalizados para melhoria contínua.',
  },
]
          ...
          <div className='container grid grid-cols-1 gap-8 text-center md:grid-cols-2 md:text-left'>
            <div className='flex flex-col justify-center space-y-4'>
              ...
              <p className='max-w-[600px] text-muted-foreground md:text-xl'>
                A plataforma tudo-em-um para gerenciar clientes, funcionários e
                processos com insights alimentados por IA para máxima
                eficiência.
              </p>
            ...
            <div className='flex flex-col items-center justify-center space-y-4 text-center'>
              <div className='space-y-2'>
                ...
                <p className='max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                  AptaFlow oferece um conjunto abrangente de ferramentas
                  projetadas para aumentar a produtividade, melhorar a
                  satisfação do cliente e impulsionar o crescimento do negócio.
                </p>
              </div>
            </div>
        ...
        <div className='container flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0'>
          <div className='flex flex-col items-center gap-4 px-8 md:flex-row md:gap-2 md:px-0'>
            ...
            <p className='text-center text-sm leading-loose text-muted-foreground md:text-left'>
              © {new Date().getFullYear()} AptaFlow Inc. Todos os direitos
              reservados.
            </p>
          </div>
        </div>
